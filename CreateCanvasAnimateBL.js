window.onload = function () 
{
      ...
      document.getElementById('animation_container').appendChild(Canv);
      document.getElementById('animation_container').appendChild(Kontejner);
...
function init() {
	...
	var comp=AdobeAn.getComposition("9AA32BE4A14159428C86FDD4FA71DC01");
